    ...
    style={{
      ...
      {props.errorNetwork ?
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 10px'}}>
          ...
          <p>Se o erro persistir, entre em contato conosco para podermos ajudá-lo: <strong><a style={{textDecoration: 'underline'}} href='tel:-55-11-98176-8088'>(11) 98176-8088</a></strong></p>
        </div>
      :        
        <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: '0 10px'}}>
          ...
          <p>Estaremos prontos para ajudá-lo a acessar o aplicativo: <strong><a style={{textDecoration: 'underline'}} href='tel:-55-11-98176-8088'>(11) 98176-8088</a></strong></p>
        </div>
      }
