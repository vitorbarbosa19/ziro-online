      ...
      <div style={radioFormStyle}>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='hasStore'
            value='Sim'
            checked={props.hasStore === 'Sim' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='hasStore'
            value='Não'
            checked={props.hasStore === 'Não' ? true : false}
          />
        </div>
      </div>
      ...
      <div style={radioFormStyle}>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='maxPay'
            value='Até R$59,00'
            checked={props.maxPay === 'Até R$59,00' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            checked={props.maxPay === 'Entre R$59,00 e R$200,00' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            checked={props.maxPay === 'Acima de R$200,00' ? true : false}
          />
        </div>
      </div>
      ...
      <div style={radioFormStyle}>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='referral'
            value='Instagram'
            checked={props.referral === 'Instagram' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='referral'
            value='Blog'
            checked={props.referral === 'Blog' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='referral'
            value='Indicação'
            checked={props.referral === 'Indicação' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            checked={props.referral === 'Já sou cliente' ? true : false}
          />
        </div>
        <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <input
            ...
            name='referral'
            value='Não lembro'
            checked={props.referral === 'Não lembro' ? true : false}
          />
        </div>
      </div>
        ...
        <div style={radioFormStyle}>
          <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            <input
              ...
              checked={props.when === 'O quanto antes' ? true : false}
            />
          </div>
          <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            <input
              ...
              checked={props.when === 'Em até 3 meses' ? true : false}
            />
          </div>
          <div style={{width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
            ...
            <input
              ...
              checked={props.when === 'Ainda não sei, estou pesquisando' ? true : false}
            />
          </div>
        </div>
      }
